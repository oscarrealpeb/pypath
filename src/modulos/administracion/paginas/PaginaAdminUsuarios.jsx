      ...
      <Tarjeta accent className="space-y-6">
        <div className="space-y-4">
          ...
          <p className="max-w-3xl text-lg leading-8 text-mute">
            ...
            deshabilitación de cuentas, reinicio de contraseña y vista rápida del progreso individual.
          </p>
        </div>
            ...
            <Tarjeta key={user.id} className="space-y-5">
              <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
                <div className="space-y-3">
                  <div className="flex flex-wrap items-center gap-2">
                    ...
                    {userStates[user.id]?.mustResetPassword && (
                      <span className="status-chip">Pendiente de reset</span>
                    )}
                  </div>
                  <div>
              ...
              <div className="flex flex-col gap-3 lg:flex-row">
                <Boton
                  ...
                  disabled={!canEdit}
                  onClick={() =>
                    setSystemRole(user.id, user.systemRole === 'admin' ? 'student' : 'admin')
                  }
                >
                ...
                <Boton
                  variant="secondary"
                  onClick={() => requestPasswordReset(user.id)}
                >
                  Marcar reset de contraseña
                </Boton>
                <Boton
                  variant="ghost"
                  disabled={!canEdit}
