...
export function PaginaAdminUsuarios() {
  ...
  function getRoleRestriction(user) {
    ...
    if (user.systemRole !== 'admin' && user.provider !== 'email') {
      return 'Esta cuenta usa Google. Para darle acceso administrativo, primero necesita una cuenta con correo y contraseña.'
    }
